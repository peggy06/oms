<?php $__env->startSection('content'); ?>
    <?php /*<div style=" width: 100%; height: 100%;">*/ ?>
        <?php /*<img src="<?php echo e(asset('images/logo_red_hd.png')); ?>" alt="" width="50%" height="50%" style="display: block;margin: auto;" class="img-responsive">*/ ?>
    <?php /*</div>*/ ?>
            ...
            <div class="wrapper">
                <div class="row">
                    <div class="col-md-8" style="margin-bottom: 30px;">
                        <div style="width: 100%;">
                        <img src="<?php echo e(asset('images/headereditable.png')); ?>" alt="" width="450px" class="img-responsive" style="display: block; margin: auto;">
                        </div>
                        <br>
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="<?php echo e(asset('images/2.jpg')); ?>" alt="banner" width="100%">
                                </div>

                                <div class="item">
                                    <img src="<?php echo e(asset('images/4.jpg')); ?>" alt="banner" width="100%">
                                </div>

                                <div class="item">
                                    <img src="<?php echo e(asset('images/3.jpg')); ?>" alt="banner" width="100%">
                                </div>

                                <div class="item">
                                    <img src="<?php echo e(asset('images/1.jpg')); ?>" alt="banner" width="100%">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div style="border: solid 2px #e2e2e2;background-color: #fff;padding: 10px">
                                    <a href="http://www.freepik.com" target="_blank" style="color: #000;text-decoration: none">
                                        ...
                                        <img src="<?php echo e(asset('images/freepik-logo-horizontal_318-39883.jpg')); ?>" alt="" width="100%">
                                    </a>
                                </div>
                            </div>
                        </div>
