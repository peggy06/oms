    ...
    <div style="background-color: #5e5e5e">
        <div class="legal margin-default">
            ...
            <p style="font-size: 12pt; text-indent: 0.5in" class="text-justify">
                I, <ins class="tele-type">&nbsp;&nbsp;&nbsp;<b>{{ auth()->user()->name }}</b>&nbsp;&nbsp;&nbsp;</ins> of legal age, single/married and residing at ______________________________________________________ through the request of Bulacan State Unniversity and
                <ins class="tele-type">
                    &nbsp;&nbsp;&nbsp;
                    @if($company->count() != 0)
                        <b>{{ $company->name }}</b>
