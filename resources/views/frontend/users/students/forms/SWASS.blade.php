        ...
        <div class="legal margin-default">
            ...
            <p style="font-size: 12pt;">
                    <span class="pull-left">
                        Student Trainee: <ins>{{ auth()->user()->name }}</ins>
                    </span>
                    <span class="pull-right">
                        Technology Area: <ins>{{ auth()->user()->profile->technology_area }}</ins>
                    </span><br>
                    <span class="pull-left">
                        Supervisor: <ins>{{ auth()->user()->profile->company_supervisor }}</ins>
                    </span>
                    <span class="pull-right">
                ...
                @foreach($swass as $dtr)
                    <tr>
                        <td>
                            ...
                            Time-out: {{ $dtr->updated_at->format('H:i:s a')}} 
                        </td>
