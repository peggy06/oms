                ...
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4><i class="fa fa-comments-o fa-fw"></i> Messages | <a href="{{ route('adviserInbox') }}" class="small"> Back to inbox</a></h4>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <div class="col-lg-6 col-lg-offset-3">
                                    <div class="chat-panel panel panel-default" id="chat">
                                        ...
                                        <div class="panel-footer">
                                                {{ Form::open(['method' => 'post', 'url' => route('messageSend', [encrypt($sender), $chat_id])]) }}
