                                ...
                                <div class="panel chat-panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <ul class="list-unstyled chat">
                                            <li><a href="{{ route('adminShowWaiverLetter', $user->id) }}">Waiver</a></li>
                                            <li><a href="">SWAS</a></li>
                                            <li><a href="{{ route('adminShowPersonalLetter', $user->id) }}">Personal Information</a></li>
                                            <li><a href="{{ route('adminShowEvaluationLetter', $user->id) }}">OJT Evaluation</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
